...
using TapAi.Module.Media.Infrastructure.Services;
using TapAi.Module.Media.Infrastructure.Settings;
using TapAi.Module.Media.Persistence.BackgroundServices;
using TapAi.Module.Media.Persistence.Consumers;
using TapAi.Module.Media.Persistence.Contexts;

namespace TapAi.Module.Media.DependencyInjection.Extensions;
